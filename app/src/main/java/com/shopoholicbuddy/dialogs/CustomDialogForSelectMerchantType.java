...
public class CustomDialogForSelectMerchantType extends Dialog {

    private final String selectedCountry;
    private final String selectedCountryCode;
    @BindView(R.id.rb_product_seller)
    RadioButton rbProductSeller;
    @BindView(R.id.rb_service_provider)
    RadioButton rbSeviceProvider;
    ...
    public CustomDialogForSelectMerchantType(Context mContext, String selectedCountry, String selectedCountryCode, SelectCountryDialogCallback selectCountryDialogCallback) {
        super(mContext);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mContext instanceof SignupActivity) {
            if (rbProductSeller.getText().toString().equals(selectedCountry)) rbProductSeller.setChecked(true);
            else if (rbSeviceProvider.getText().toString().equals(selectedCountry)) rbSeviceProvider.setChecked(true);
            else if (rbBoth.getText().toString().equals(selectedCountry))
        ...
        switch (view.getId()) {
            case R.id.tv_done:
                ...
                if (rbCountry != null) {
                    ...
                    AppUtils.getInstance().showToast(mContext, "please select merchan type");
                }
                break;
        }
    }
